...
> LH(한국토지주택공사) 임직원이 AI와 대화할 때 **법령·내부규정·건설기준·판례·조달청 해석사례**를 자동으로 검색해주는 MCP 서버
...
- 납기를 초과한 경우 지체상금 산정 기준일과 상한액 적용 방법이 어떻게 되나요?
- 설계변경으로 공사 물량이 증가했을 때 계약금액 조정 절차와 요건은 무엇인가요?
